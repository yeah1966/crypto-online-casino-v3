    ...
    <>
      ...
      <div className="relative min-h-screen w-full pt-32">
        ...
        <div className="pointer-events-none fixed inset-0 z-0" aria-hidden="true">
          <img src="/images/crypto-casino-online-mobile.webp" alt="Crypto Online Casino background" className="w-full h-full object-cover opacity-60" />
        </div>
        ...
        <div className="relative z-10">
          ...
          <div className="pt-10 pb-4">
            ...
            <div className="relative flex justify-center mb-6">
              ...
              <img src="/logos/crypto-mascot.png" alt="Crypto Casino Mascot" className="relative w-32 h-32 md:w-48 md:h-48 drop-shadow-neon animate-[wiggle_1.5s_ease-in-out_infinite]" style={{ objectFit: 'contain' }} />
            </div>
            {/* Main heading */}

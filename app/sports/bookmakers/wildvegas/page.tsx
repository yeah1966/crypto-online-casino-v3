      ...
      <main className="relative min-h-screen py-12 px-2 md:px-0">
        <div className="max-w-3xl mx-auto bg-black/70 rounded-3xl p-6 md:p-12 shadow-2xl border-2 border-yellow-400/20 text-white">
          ...
          <section className="mb-10">
            ...
            <a href="https://www.wildvegaslinks.com/click/11/4315/15512/1" target="_blank" rel="noopener noreferrer" className="inline-block bg-yellow-400 text-black font-bold px-8 py-3 rounded-full shadow-lg hover:bg-yellow-300 transition text-lg mt-2">Claim your Wild Vegas Bonus</a>
          </section>

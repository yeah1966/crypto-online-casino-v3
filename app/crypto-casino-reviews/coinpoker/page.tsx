  ...
  return (
    ...
    <section id="first-impressions" className="mb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <Image src="/screenshots/coinpoker1.jpg" alt="Screenshot 1" className="rounded-xl shadow-[0_0_12px_#ff00ff66] object-cover h-40 w-full transition-all duration-300 ease-in-out hover:scale-105" width={800} height={160} />
        <Image src="/screenshots/coinpoker2.jpg" alt="Screenshot 2" className="rounded-xl shadow-[0_0_12px_#ff00ff66] object-cover h-40 w-full transition-all duration-300 ease-in-out hover:scale-105" width={800} height={160} />
        <Image src="/screenshots/coinpoker3.jpg" alt="Screenshot 3" className="rounded-xl shadow-[0_0_12px_#ff00ff66] object-cover h-40 w-full transition-all duration-300 ease-in-out hover:scale-105" width={800} height={160} />
        <Image src="/screenshots/coinpoker4.jpg" alt="Screenshot 4" className="rounded-xl shadow-[0_0_12px_#ff00ff66] object-cover h-40 w-full transition-all duration-300 ease-in-out hover:scale-105" width={800} height={160} />
      </div>
    ...
    <div className="bg-gradient-to-r from-purple-900 to-purple-700 border-2 border-pink-500 shadow-[0_0_20px_#ff00ff] rounded-xl px-6 py-4 mb-8 grid grid-cols-1 sm:grid-cols-3 items-center">
      ...
      <div className="flex justify-start items-center mb-4 sm:mb-0">
        <Image src="/logos/coinpoker.png" alt="CoinPoker logo" className="w-16 h-auto mr-4" width={64} height={64} />
      </div>
      {/* Title centered */}
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
      ...
      <section className="bg-gradient-to-br from-[#1a2c8b] to-[#0a0f40] border-2 border-yellow-400 rounded-xl p-6 text-white shadow-[0_0_10px_rgba(255,255,255,0.1)] hover:scale-[1.03] hover:shadow-[0_0_20px_#ff00ff55] transition-all duration-300 ease-in-out">
        ...
        <div className="flex gap-4 items-center mt-4 flex-wrap">
          ...
          <Image src="/icons/eth.svg" alt="Ethereum" className="w-8 h-8" title="Ethereum (ETH)" width={32} height={32} />
          <Image src="/icons/chp.svg" alt="CoinPoker" className="w-8 h-8" title="CoinPoker (CHP)" width={32} height={32} />
        </div>
        <p className="mt-4">

...
export const generateMetadata = (): Metadata => {
  return {
    title: "Crown Slots Casino Review 2025 | Royal Slots & Crypto Accepted",
    description: "Read our Crown Slots review: royal theme, 100s of slots, fast payouts, and crypto accepted. Licensed by UKGC & MGA.",
    alternates: {
      canonical: "https://crypto-online-casino.com/crypto-casino-reviews/crownslots",
    },
    openGraph: {
      title: "Crown Slots Casino Review 2025 | Royal Slots & Crypto Accepted",
      description: "Read our Crown Slots review: royal theme, 100s of slots, fast payouts, and crypto accepted. Licensed by UKGC & MGA.",
      url: "https://crypto-online-casino.com/crypto-casino-reviews/crownslots",
      type: "website",
      images: [
        {
          url: "https://crypto-online-casino.com/og/crownslots.png",
          width: 1200,
          height: 630,
          alt: "Crown Slots Casino OG Image",
        },
      ],
    },
    twitter: {
      ...
      title: "Crown Slots Casino Review 2025 | Royal Slots & Crypto Accepted",
      description: "Read our Crown Slots review: royal theme, 100s of slots, fast payouts, and crypto accepted. Licensed by UKGC & MGA.",
      images: ["https://crypto-online-casino.com/og/crownslots.png"],
    },
  };
};
...
const data = {
  ...
  bonuses: `New players at Crown Slots can claim a generous welcome bonus, including matched deposits and free spins. There are frequent promotions, prize draws, and a loyalty program with exclusive rewards for returning players.`,
  games: `Crown Slots features hundreds of slots, live casino, and table games from top providers like NetEnt, Microgaming, and Evolution. The site is easy to navigate, making it simple to find your favorite games or discover new ones.`,
  support: `Customer support is available 24/7 via live chat and email. The Crown Slots team is helpful and responsive, and there’s a comprehensive help section for common questions.`,
  mobile: `Crown Slots is fully optimized for mobile, allowing players to enjoy all games and features on smartphones and tablets, with no app download required.`,
  security: `Crown Slots operates under a reputable gaming license and uses SSL encryption to protect player data. The platform is committed to responsible gambling and is regularly audited for fairness.`,
  payments: `Crown Slots supports a variety of payment methods, including credit/debit cards, e-wallets, and select cryptocurrencies. Deposits and withdrawals are processed quickly and securely.`,
  verdict: `With its royal theme, strong game selection, and reliable payouts, Crown Slots is a great choice for players looking for a trustworthy and entertaining online casino experience.`,
  facts: {
    founded: "2019",
    license: "UKGC & MGA",
  ...
  <div className="max-w-screen-xl mx-auto py-10 px-4 bg-dark text-white">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
      ...
      <section className="p-6 bg-[#0e1a46] rounded-xl border border-yellow-500 shadow-md text-white">
        ...
        <p>
          Crown Slots supports a variety of cryptocurrencies and digital payment methods for convenient and secure transactions. Supported coins include:
        </p>
...
export default CrownSlotsReview;

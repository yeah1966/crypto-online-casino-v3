...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://crypto-online-casino.com/crypto-casino-reviews/cloudbet",
    },
    openGraph: {
      title: "Cloudbet Casino Review 2025 | Crypto Casino & Sportsbook Pioneer",
      description: "Read our Cloudbet review: crypto pioneer, high limits, instant payouts, 1000+ games & sportsbook. Trusted since 2013.",
      url: "https://crypto-online-casino.com/crypto-casino-reviews/cloudbet",
      type: "website",
      images: [
        {
...
const data = {
  ...
  bonuses: `New Cloudbet players receive a generous welcome bonus, often matched in Bitcoin or other cryptocurrencies. Regular promotions, free bets, tournaments, and a loyalty program provide ongoing value for both casino and sportsbook users.`,
  games: `Cloudbet offers thousands of games from top providers such as Evolution, NetEnt, and Play'n GO. The selection includes slots, live dealer games, provably fair crypto games, and a robust sportsbook for betting on major and niche sports events.`,
  support: `24/7 customer support is available via live chat and email. The Cloudbet team is knowledgeable and quick to assist, and there is a comprehensive help center for self-service support.`,
  mobile: `Cloudbet’s mobile site is fully responsive, allowing for seamless play, deposits, and withdrawals on any device. No app download is required to access the full range of features on smartphones and tablets.`,
  security: `Cloudbet operates under a Curacao eGaming license and uses advanced SSL encryption to protect player data. The casino is committed to responsible gambling and undergoes regular audits for fairness and transparency.`,
  payments: `Cloudbet is a true crypto-first platform, supporting Bitcoin (BTC), Ethereum (ETH), Litecoin (LTC), Bitcoin Cash (BCH), Dogecoin (DOGE), and Tether (USDT). Payments are processed instantly and securely, with high limits and low fees.`,
  verdict: `Cloudbet stands out for its deep crypto integration, high betting limits, and excellent reputation. It’s a top choice for players seeking both casino games and sports betting with the flexibility and privacy of cryptocurrencies.`,
  facts: {
    founded: "2013",

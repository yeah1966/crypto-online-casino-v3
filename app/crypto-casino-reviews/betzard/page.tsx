  ...
  return (
    ...
    <section id="first-impressions" className="mb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <Image src="/screenshots/betzard1.jpg" alt="Screenshot 1" width={800} height={160} className="rounded-xl shadow-[0_0_12px_#ff00ff66] object-cover h-40 w-full transition-all duration-300 ease-in-out hover:scale-105" />
        <Image src="/screenshots/betzard2.jpg" alt="Screenshot 2" width={800} height={160} className="rounded-xl shadow-[0_0_12px_#ff00ff66] object-cover h-40 w-full transition-all duration-300 ease-in-out hover:scale-105" />
        <Image src="/screenshots/betzard3.jpg" alt="Screenshot 3" width={800} height={160} className="rounded-xl shadow-[0_0_12px_#ff00ff66] object-cover h-40 w-full transition-all duration-300 ease-in-out hover:scale-105" />
        <Image src="/screenshots/betzard4.jpg" alt="Screenshot 4" width={800} height={160} className="rounded-xl shadow-[0_0_12px_#ff00ff66] object-cover h-40 w-full transition-all duration-300 ease-in-out hover:scale-105" />
      </div>
    ...
    <div className="bg-gradient-to-r from-purple-900 to-purple-700 border-2 border-pink-500 shadow-[0_0_20px_#ff00ff] rounded-xl px-6 py-4 mb-8 grid grid-cols-1 sm:grid-cols-3 items-center">
      ...
      <div className="flex justify-start items-center mb-4 sm:mb-0">
        <Image src="/logos/betzard.png" alt="Betzard logo" width={64} height={64} className="w-16 h-auto mr-4" />
      </div>
      {/* Title centered */}

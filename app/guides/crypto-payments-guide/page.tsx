        ...
        <div className="w-full max-w-3xl mx-auto flex flex-col gap-8">
          ...
          <section ref={refs.why} className="rounded-2xl border border-yellow-400/30 bg-black/80 p-5 shadow-lg flex flex-col gap-2">
            ...
            <ul className="list-disc ml-6 text-white/90 mt-2">
              <li className="flex items-center gap-2 mb-1"><img src="/icons/bolt.svg" alt="Fast" width={18} height={18} />Instant deposits & withdrawals</li>
              <li className="flex items-center gap-2 mb-1"><img src="/icons/shib.svg" alt="Privacy" width={18} height={18} />Private & borderless payments</li>
              <li className="flex items-center gap-2 mb-1"><img src="/casino-icons/Lock.svg" alt="Security" width={18} height={18} />No bank or credit card needed</li>
              <li className="flex items-center gap-2 mb-1"><img src="/casino-icons/koc.png" alt="No KYC" width={18} height={18} />Often no KYC required</li>
            </ul>
          </section>
          ...
          <section ref={refs.safe} className="rounded-2xl border border-green-400/30 bg-black/80 p-5 shadow-lg flex flex-col gap-2">
            <h2 className="text-2xl font-bold flex items-center gap-2 mb-2 text-green-600">
              <img src="/casino-icons/Shield.svg" alt="Shield" width={32} height={32} />
              Is It Safe?
            </h2>
            <ul className="list-disc ml-6 text-white/90 mt-2">
              <li className="flex items-center gap-2 mb-1"><img src="/icons/bolt.svg" alt="Blockchain" width={18} height={18} />Crypto uses blockchain technology</li>
              <li className="flex items-center gap-2 mb-1"><img src="/casino-icons/Lock.svg" alt="Lock" width={18} height={18} />Transactions are encrypted & secure</li>
              <li className="flex items-center gap-2 mb-1"><img src="/icons/ledger.svg" alt="Ledger" width={18} height={18} />Use a hardware wallet for max safety</li>
              <li className="flex items-center gap-2 mb-1"><img src="/icons/Bitcoin.svg" alt="Bitcoin" width={18} height={18} />Choose trusted casinos (see our reviews)</li>
            </ul>
          </section>
          ...
          <section ref={refs.how} className="rounded-2xl border border-blue-400/30 bg-black/80 p-5 shadow-lg flex flex-col gap-2">
            <h2 className="text-2xl font-bold flex items-center gap-2 mb-2 text-blue-600">
              <img src="/casino-icons/Strategy Tips.svg" alt="How" width={32} height={32} />
              How Do Crypto Payments Work?
            </h2>
            <ol className="list-decimal ml-6 text-white/90 mt-2">
              <li className="flex items-center gap-2 mb-1"><img src="/icons/Bitcoin.svg" alt="Bitcoin" width={18} height={18} />Get crypto (buy on exchange or wallet)</li>
              <li className="flex items-center gap-2 mb-1"><img src="/casino-icons/Poker Chip.svg" alt="Chip" width={18} height={18} />Go to your casino & click “Deposit”</li>
              <li className="flex items-center gap-2 mb-1"><img src="/icons/bolt.svg" alt="Fast" width={18} height={18} />Send coins from your wallet</li>
              <li className="flex items-center gap-2 mb-1"><img src="/casino-icons/Lock.svg" alt="Lock" width={18} height={18} />Wait for confirmation (seconds–minutes)</li>
              <li className="flex items-center gap-2 mb-1"><img src="/casino-icons/Roulette Wheel.svg" alt="Play" width={18} height={18} />Play instantly!</li>
            </ol>
          </section>
          ...
          <section ref={refs.coins} className="rounded-2xl border border-orange-400/30 bg-black/80 p-5 shadow-lg flex flex-col gap-2">
            ...
            <div className="flex flex-wrap gap-4 mt-2">
              <img src="/icons/Bitcoin.svg" alt="Bitcoin" width={38} height={38} />
              <img src="/icons/eth.svg" alt="Ethereum" width={38} height={38} />
              <img src="/icons/ltc.svg" alt="Litecoin" width={38} height={38} />
              <img src="/icons/usdt.svg" alt="USDT" width={38} height={38} />
              <img src="/icons/doge.svg" alt="Dogecoin" width={38} height={38} />
              <img src="/icons/shib.svg" alt="Shiba Inu" width={38} height={38} />
              <img src="/icons/ada.svg" alt="Cardano" width={38} height={38} />
              <img src="/icons/sol.svg" alt="Solana" width={38} height={38} />
              <img src="/icons/bnb.svg" alt="BNB" width={38} height={38} />
              <img src="/icons/matic.svg" alt="Matic" width={38} height={38} />
            </div>
          ...
          <section ref={refs.compare} className="rounded-2xl border border-purple-400/30 bg-black/80 p-5 shadow-lg flex flex-col gap-2">
            <h2 className="text-2xl font-bold flex items-center gap-2 mb-2 text-purple-600">
              <img src="/casino-icons/Bar.svg" alt="Compare" width={32} height={32} />
              ...
              <table className="w-full text-left rounded-xl overflow-hidden border border-purple-400">
                ...
                <tbody className="bg-white/90 text-black">
                  <tr>
                    ...
                    <td className="px-4 py-2">Seconds–Minutes <img src='/icons/bolt.svg' alt='Fast' width='18' className='inline ml-1' /></td>
                    <td className="px-4 py-2">1–5 days</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 font-semibold">Privacy</td>
                    <td className="px-4 py-2">High <img src='/icons/shib.svg' alt='Privacy' width='18' className='inline ml-1' /></td>
                    <td className="px-4 py-2">Low</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 font-semibold">Availability</td>
                    <td className="px-4 py-2">Global <img src='/casino-icons/Globe.svg' alt='Global' width='18' className='inline ml-1' /></td>
                    <td className="px-4 py-2">Region-dependent</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 font-semibold">Reversibility</td>
                    <td className="px-4 py-2">No (final) <img src='/casino-icons/Lock.svg' alt='Final' width='18' className='inline ml-1' /></td>
                    <td className="px-4 py-2">Yes</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 font-semibold">Fees</td>
                    <td className="px-4 py-2">Low or none <img src='/icons/ltc.svg' alt='Litecoin' width='18' className='inline ml-1' /></td>
          ...
          <section className="mt-8 rounded-2xl border border-green-400/30 bg-black/80 p-5 shadow-lg flex flex-col gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="flex flex-col items-center bg-gray-900/60 rounded-lg p-3 shadow">
                <img src="/icons/ledger.svg" alt="Ledger" width={44} height={44} className="mb-2" />
              ...
              <div className="flex flex-col items-center bg-cyan-900/60 rounded-lg p-3 shadow">
                <img src="/icons/trustwallet.svg" alt="Trust Wallet" width={44} height={44} className="mb-2" />
